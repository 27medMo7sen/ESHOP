      ...
      <section className="text-center py-16">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            design. Our curated collection features premium products that
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              At ModernShop, we believe that great design and cutting-edge
              technology should be accessible to everyone. We carefully select
              each product in our catalog to ensure it meets our high standards
              for quality, innovation, and user experience.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              From premium audio equipment to the latest wearables and essential
              accessories, we're here to help you discover products that truly
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="text-center shadow-card border-0 bg-card/50">
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground">
                We only offer products that we would use ourselves. Every item
          ...
          <Card className="text-center shadow-card border-0 bg-card/50">
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground">
                Your satisfaction is our priority. We provide excellent support
